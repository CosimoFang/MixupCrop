...
def get_args():
    ...
    parser.add_argument("--reverse-c", action="store_true", help="use reverse curriculum setting")
    parser.add_argument('--c-scheduler', default='stepwise',
                        type=str, help='type of scheduler')
    parser.add_argument('--cl_step', default=4, type=int, help='curriculum step')
    parser.add_argument('--lam_max', default=1.0, type=float, help='max mixup lambda')
    parser.add_argument('--lam_min', default=0.0, type=float, help='min mixup lambda')

    parser.add_argument('--mixup_option', default='vanilla', type=str, help='type of scheduler')
